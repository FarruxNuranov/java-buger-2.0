...
const numberx = document.querySelector(".title")

function numbert(){
    let num = 0;
    let interval = setInterval(() => {
        numberx.innerHTML = ++num;
        if(num === 100) {
            clearInterval(interval)
            numberx.innerHTML = `100 LVL`
            numberx.style.color = "red"
            numberx.style.transform = "scale(2)"
            numberx.style.transition = "500ms"
